...
;(function(document, window, undefined){
	...
	data.audioSprites = {
		...
		page_1: {start: 7.900, length: 12.300},
		page_2: {start: 20.700, length: 10.600},
		page_3: {start: 31.800, length: 11.500},
		page_4: {start: 43.800, length: 10.300},
		page_5: {start: 54.600, length: 12.600},
		page_6: {start: 67.700, length: 9.300},
		page_7: {start: 77.500, length: 4.500},
		title_1: {start: 82.500, length: 0.700},
		title_2: {start: 83.700, length: 0.700},
		title_3: {start: 84.900, length: 0.700},
		title_4: {start: 86.100, length: 0.800},
		go_home: {start: 87.400, length: 2.000},
		go_info: {start: 89.900, length: 0.900}
	};
	...
	function act1(){
		var pairsCnt = 3;
		var cardFrames = ShuffleArray([['card_1.png', 1], ['card_2.png', 2], ['card_3.png', 3], ['card_4.png', 4]])
		var x = Value(512);
		var y = Value(240);
		var w = Value(183);
		var h = Value(258);
