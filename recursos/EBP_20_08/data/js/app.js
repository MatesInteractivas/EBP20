...
;(function(document, window, undefined){
	...
	data.audioSprites = {
		...
		page_1: {start: 7.900, length: 7.900},
		page_2: {start: 16.300, length: 7.800},
		page_3: {start: 24.600, length: 6.300},
		page_4: {start: 31.400, length: 7.400},
		page_5: {start: 39.300, length: 8.400},
		page_6: {start: 48.200, length: 11.700},
		page_7: {start: 60.400, length: 8.500},
		page_8: {start: 69.400, length: 4.500},
		title_1: {start: 74.400, length: 0.600},
		title_2: {start: 75.500, length: 0.600},
		title_3: {start: 76.600, length: 1.000},
		title_4: {start: 78.100, length: 1.000},
		title_5: {start: 79.600, length: 1.100},
		go_home: {start: 81.200, length: 2.200},
		go_info: {start: 83.900, length: 0.900}
	};

	// IMAGES
	data.imgs = {
		loader : 'data/img/loader' + data.resSuffix + '.json',
		sprites : 'data/img/sprites' + data.resSuffix + '.json',
	...
	function setPage(nextPage){
		...
		switch(data.page){
			...
			case 2:
				...
				TweenMax.to(title, 1, {rotation: DegToRad(4), ease: Power1.easeInOut, repeat: -1, yoyo:true});				
			...
			case 3:
				...
				TweenMax.to(title, 1, {rotation: DegToRad(15), ease: Power1.easeInOut, repeat: -1, yoyo:true});	
				createSprites('next button');
				speech();
				break				
			case 4:
				...
				TweenMax.to(title, 1, {rotation: DegToRad(17), ease: Power1.easeInOut, repeat: -1, yoyo:true});	
				createSprites('next button');
				speech();
				break
			case 5:
				...
				TweenMax.to(title, 1, {rotation: DegToRad(23), ease: Power1.easeInOut, repeat: -1, yoyo:true});
				createSprites('next button');
				speech();
				break
			case 6:
